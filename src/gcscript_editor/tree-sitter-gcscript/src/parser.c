...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [14] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import, 2, 0, 0),
...
TS_PUBLIC const TSLanguage *tree_sitter_gcscript(void) {
